				...
				<?php print form::open(NULL, array('enctype' => 'multipart/form-data', 'id' => 'reportForm', 'name' => 'reportForm')); ?>
                	...
                	<div class="report-form">
						...
						<div class="f-col">
							...
							<?php } ?>
                            <?php Event::run('ushahidi_action.admin_display_add_marks', $id); ?>                                                                                                                                               
							<div class="row">
							...
							?>
                            <?php
                                //Event::run('echo_security');
                            ?>
                             <?php
                            // Action::display_admin_translate - Runs for display translate
                            Event::run('ushahidi_action.display_admin_translate', $id);
                            ?>
							<?php
							if (!($id))
