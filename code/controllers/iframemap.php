...
class Iframemap_Controller extends Template_Controller {
	...
	public function __construct()
	{
        ...
        // Load Header & Footer
		$this->template->header  = new View('iheader');
		$this->template->footer  = new View('ifooter');
    ...
    {
        $this->template->header->this_page = 'iframemap';
        $this->template->content = new View('main/iframemap');
