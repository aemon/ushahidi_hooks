...
/////// Start of block for displaying localized text of report
			$incident_title = $incident->incident_title;
           
			$title_translate = array('value'=>$incident_title,'id'=>$id,'field'=>'title');
	            Event::run('ushahidi_action.run_translate_value', $title_translate );
        	    $incident_title = $title_translate['value'];
            
            	    $incident_description = $incident->incident_description;
            
	            $description_translate = array('value'=>$incident_description,'id'=>$id,'field'=>'text');
	            Event::run('ushahidi_action.run_translate_value', $description_translate );
	            $incident_description = $description_translate['value'];

/////// end of block for displaying localized report
